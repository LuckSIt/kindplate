...
VALUES (
    (SELECT id FROM users WHERE email = 'coffee@kindplate.ru'),
    'Капучино + Круассан',
    'Ароматный капучино и свежий круассан',
    380.00,
    190.00,
    15,
    '18:00:00',
...
VALUES (
    (SELECT id FROM users WHERE email = 'coffee@kindplate.ru'),
    'Американо + Маффин',
    'Классический американо и шоколадный маффин',
    320.00,
    160.00,
    10,
    '17:00:00',
...
INSERT INTO offers (business_id, title, description, original_price, discounted_price, quantity_available, pickup_time_start, pickup_time_end, is_active)
VALUES (
    (SELECT id FROM users WHERE email = 'bakery@kindplate.ru'),
    'Набор выпечки',
    'Ассорти из 5 видов свежей выпечки',
    450.00,
    225.00,
    8,
    '19:00:00',
...
INSERT INTO offers (business_id, title, description, original_price, discounted_price, quantity_available, pickup_time_start, pickup_time_end, is_active)
VALUES (
    (SELECT id FROM users WHERE email = 'sushi@kindplate.ru'),
    'Сет Филадельфия',
    '24 ролла с лососем и сливочным сыром',
    1200.00,
    600.00,
    5,
    '20:00:00',
...
VALUES (
    (SELECT id FROM users WHERE email = 'sushi@kindplate.ru'),
    'Мисо суп',
    'Традиционный японский суп с тофу',
    180.00,
    90.00,
    12,
    '19:00:00',
...
INSERT INTO offers (business_id, title, description, original_price, discounted_price, quantity_available, pickup_time_start, pickup_time_end, is_active)
VALUES (
    (SELECT id FROM users WHERE email = 'pizza@kindplate.ru'),
    'Пицца Маргарита 40см',
