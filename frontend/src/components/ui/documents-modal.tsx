        ...
        return (
          <div className="documents-modal__content">
            <h2 className="documents-modal__content-title">
              ПОЛИТИКА КОНФИДЕНЦИАЛЬНОСТИ И ОБРАБОТКИ ПЕРСОНАЛЬНЫХ ДАННЫХ СОММИЛ
            </h2>
            ...
            <div className="documents-modal__content-section">
              ...
              <p className="documents-modal__content-text">
                <strong>1.1.</strong> Настоящая Политика конфиденциальности (далее — «Политика») определяет порядок обработки и защиты персональных данных пользователей платформы Соммил (сайт и мобильное приложение) индивидуальным предпринимателем ИП А. М. Сатаев (ИНН: 784808895487, ОГРН: 326784700012921, далее — «Оператор», «мы»).
              </p>
              <p className="documents-modal__content-text">
              ...
              <p className="documents-modal__content-text">
                <strong>1.4.</strong> Если пользователь не согласен с условиями Политики, он обязан немедленно прекратить использование платформы Соммил.
              </p>
            </div>
            ...
            <div className="documents-modal__content-section">
              ...
              <p className="documents-modal__content-text">
                <strong>2.1.</strong> «Платформа Kindplate» (далее — «Платформа») — сайт и мобильное приложение Соммил, принадлежащие Оператору и предназначенные для взаимодействия пользователей с партнёрами (ресторанами, кафе, магазинами) по бронированию и покупке продуктов с истекающим сроком годности.
              </p>
              <p className="documents-modal__content-text">
...
*/
        ...
        return (
          <div className="documents-modal__content">
            ...
            <div className="documents-modal__content-section">
              ...
              <p className="documents-modal__content-text">
                Продолжая использовать сайт Соммил (включая навигацию, авторизацию или совершение действий), Вы выражаете полное и безоговорочное согласие с условиями настоящего Соглашения. Если Вы не согласны, пожалуйста, отключите cookies в настройках браузера или покиньте сайт.
              </p>
            </div>
      ...
      case 'offer':
        return (
          <div className="documents-modal__content">
            <h2 className="documents-modal__content-title">
              ПУБЛИЧНАЯ ОФЕРТА ПЛАТФОРМЫ СОММИЛ
            </h2>
            <p className="documents-modal__content-subtitle">
              г. Санкт-Петербург, «26» января 2026 г.
            </p>
