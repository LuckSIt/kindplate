    ...
    return (
        <div className="w-full min-h-screen bg-[#10172A] flex flex-col items-center pb-0" style={{ fontFamily: 'Montserrat Alternates, sans-serif' }}>
            ...
            <div className="w-[350px] h-[59px] rounded-[15px] bg-[#D9D9D9] flex items-start mt-0 px-[14px] py-[7px]">
                {/* Avatar */}
                <div className="w-[46px] h-[46px] overflow-hidden flex items-end justify-end flex-shrink-0">
                    <svg className="w-[38.33px] h-[38.33px] text-[#10172A]" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/>
                    </svg>
                </div>
                {/* Name and Edit */}
                <div className="w-[173px] h-[35px] mt-[14px] ml-[3px] relative">
                    <div className="absolute top-0 left-0 text-[18px] font-semibold text-[#000000] leading-[22px]" style={{ fontFamily: 'Montserrat Alternates, sans-serif' }}>
                        {user?.name || 'Пользователь'}
                    </div>
                    <button className="absolute top-[13px] left-0 text-[11px] font-semibold text-[#767676] leading-[22px]" style={{ fontFamily: 'Montserrat Alternates, sans-serif' }}>
                        изменить информацию
                    </button>
                </div>
            </div>
            ...
            <div className="mt-[27px] flex flex-col items-start w-[350px]">
                ...
                <div className="relative w-[350px] h-[291px] rounded-[15px] border border-white bg-[#2B344D]">
                    ...
                    >
                        <div className="w-[50px] h-[50px] rounded-[10px] bg-[#DB7E2F] flex items-center justify-center flex-shrink-0">
                            <svg className="w-[20px] h-[18.35px] text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                                <path strokeLinecap="round" strokeLinejoin="round" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                            </svg>
                        </div>
                        <div className="ml-[14px] text-[18px] font-semibold text-white leading-[22px] flex-shrink-0" style={{ fontFamily: 'Montserrat Alternates, sans-serif' }}>Избранное</div>
                        <div className="w-[24px] h-[24px] ml-[104px] flex justify-end items-center">
                    ...
                    <button 
                        ...
                        className="absolute top-[85px] left-[23px] flex items-start w-[301px] h-[50px]"
                    >
                        <div className="w-[50px] h-[50px] rounded-[10px] bg-[#35741F] flex items-center justify-center flex-shrink-0">
                            <svg className="w-[20px] h-[20px] text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                                <path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                        </div>
                        <div className="mt-[15px] ml-[14px] text-[18px] font-semibold text-white leading-[22px] flex-shrink-0" style={{ fontFamily: 'Montserrat Alternates, sans-serif' }}>История заказов</div>
                        <div className="w-[24px] h-[24px] mt-[13px] ml-[39px] flex justify-end items-center">
                            <svg className="w-[5px] h-[10px] text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                            </svg>
                        </div>
                    ...
                    >
                        <div className="w-[50px] h-[50px] rounded-[10px] bg-[#AEB26B] flex items-center justify-center flex-shrink-0">
                        ...
                        <div className="ml-[14px] text-[18px] font-semibold text-white leading-[16px] flex-shrink-0" style={{ fontFamily: 'Montserrat Alternates, sans-serif' }}>
                            <div>Пищевые</div>
                            <div>предпочтения</div>
                        </div>
                        <div className="w-[24px] h-[24px] ml-[64px] flex justify-end items-center">
                            <svg className="w-[5px] h-[10px] text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                            </svg>
                        </div>
                    ...
                    >
                        <div className="w-[50px] h-[50px] rounded-[10px] bg-[#AEC2A6] flex items-center justify-center flex-shrink-0">
                        ...
                        <div className="ml-[14px] text-[18px] font-semibold text-white leading-[22px] flex-shrink-0" style={{ fontFamily: 'Montserrat Alternates, sans-serif' }}>Уведомления</div>
                        <div className="w-[24px] h-[24px] ml-[79px] flex justify-end items-center">
                            <svg className="w-[5px] h-[10px] text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                            </svg>
                        </div>
                ...
                <button 
                    onClick={() => {}}
                    className="mt-[19px] flex items-center justify-start w-[324px] h-[24px]"
                >
                    <div className="text-[17px] font-semibold text-white flex-shrink-0" style={{ fontFamily: 'Montserrat Alternates, sans-serif' }}>Служба поддержки</div>
                    <div className="w-[24px] h-[24px] ml-[118px] flex justify-end items-center">
                        <svg className="w-[5px] h-[10px] text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        </svg>
                    </div>
                ...
                <button 
                    onClick={() => {}}
                    className="mt-[10px] flex items-center justify-start w-[324px] h-[24px]"
                >
                    <div className="text-[17px] font-semibold text-white flex-shrink-0" style={{ fontFamily: 'Montserrat Alternates, sans-serif' }}>Пригласить друзей</div>
                    <div className="w-[24px] h-[24px] ml-[112px] flex justify-end items-center">
                        <svg className="w-[5px] h-[10px] text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        </svg>
                    </div>
                ...
                <button 
                    onClick={() => {}}
                    className="mt-[9px] flex items-center justify-start w-[324px] h-[24px]"
                >
                    <div className="text-[17px] font-semibold text-white flex-shrink-0" style={{ fontFamily: 'Montserrat Alternates, sans-serif' }}>О нас</div>
                    <div className="w-[24px] h-[24px] ml-[247px] flex justify-end items-center">
                        <svg className="w-[5px] h-[10px] text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        </svg>
                    </div>
            ...
            {/* Информационный блок */}
            <div className="w-full h-[168px] bg-[#2B344D] mt-[83px] flex flex-col items-start">
                <div className="w-[310px] h-[88px] mt-[10px] ml-[26px] flex justify-start items-start">
                    {/* О KindPlate */}
                    <div className="relative w-[122px] h-[88px]">
                        <div className="absolute top-0 left-px text-[14px] font-semibold text-[#35741F] leading-[22px]" style={{ fontFamily: 'Montserrat Alternates, sans-serif' }}>KindPlate</div>
                        <div className="w-[122px] h-[67px] absolute top-[21px] left-0">
                            <button className="absolute top-0 left-0 text-[11px] font-semibold text-white leading-[22px]" style={{ fontFamily: 'Montserrat Alternates, sans-serif' }}>Для партнеров</button>
                            <button className="absolute top-[15px] left-0 text-[11px] font-semibold text-white leading-[22px]" style={{ fontFamily: 'Montserrat Alternates, sans-serif' }}>Для пользователей</button>
                            <button className="absolute top-[30px] left-0 text-[11px] font-semibold text-white leading-[22px]" style={{ fontFamily: 'Montserrat Alternates, sans-serif' }}>Документы</button>
                            <button className="absolute top-[45px] left-0 text-[11px] font-semibold text-white leading-[22px]" style={{ fontFamily: 'Montserrat Alternates, sans-serif' }}>Блог</button>
                        </div>
                    </div>

                    {/* Помощь */}
                    <div className="ml-[60px] relative w-[128px] h-[58px]">
                        <div className="absolute top-0 left-0 text-[14px] font-semibold text-[#35741F] leading-[22px]" style={{ fontFamily: 'Montserrat Alternates, sans-serif' }}>Нужна помощь?</div>
                        <div className="w-[128px] h-[37px] absolute top-[21px] left-0">
                            <button className="absolute top-0 left-0 text-[11px] font-semibold text-white leading-[22px]" style={{ fontFamily: 'Montserrat Alternates, sans-serif' }}>Ответы на вопросы</button>
                            <button className="absolute top-[15px] left-0 text-[11px] font-semibold text-white leading-[22px]" style={{ fontFamily: 'Montserrat Alternates, sans-serif' }}>Контакты</button>
                        </div>
                    </div>
                </div>

                {/* Социальные сети */}
                <div className="mt-[3px] ml-[27px] flex flex-col items-start w-[140px] h-[53px]">
                    <div className="text-[14px] font-semibold text-[#35741F] leading-[22px] flex-shrink-0" style={{ fontFamily: 'Montserrat Alternates, sans-serif' }}>Социальные сети</div>
                    <div className="w-[133px] h-[31px] flex justify-start items-center mt-0">
                        <a href="#" className="w-[25px] h-[25px] flex items-center justify-center">
                            <span className="text-white text-[10px] font-bold">VK</span>
                        </a>
                        <a href="#" className="w-[25px] h-[25px] ml-[11px] flex items-center justify-center">
                            <svg className="w-[14px] h-[14px] text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8" />
                            </svg>
                        </a>
                        <a href="#" className="w-[31px] h-[31px] ml-[8px] flex items-center justify-center">
                        ...
                        <a href="#" className="w-[25px] h-[25px] ml-[8px] flex items-center justify-center">
                            <svg className="w-[14px] h-[14px] text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* Bottom Navigation */}
            <div className="w-full h-[73px] bg-[#D9D9D9] mt-px flex justify-start items-start">
                <button 
                    onClick={() => navigate({ to: "/list" })}
                    className="mt-[18px] ml-[46px] relative w-[47px] h-[43px] flex flex-col items-center"
                >
                    <svg className="w-[28px] h-[28px] text-[#757575] mb-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                        <path strokeLinecap="round" strokeLinejoin="round" d="M4 6h16M4 12h16M4 18h16" />
                    </svg>
                    <span className="absolute top-[21px] left-0 text-[12px] font-semibold text-[#757575] leading-[22px]" style={{ fontFamily: 'Montserrat Alternates, sans-serif' }}>Список</span>
                </button>
                <button 
                    onClick={() => navigate({ to: "/home" })}
                    className="mt-[18px] ml-[85px] relative w-[46px] h-[43px] flex flex-col items-center"
                >
                    <svg className="w-[28px] h-[28px] text-[#767676] mb-0" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/>
                    </svg>
                    <span className="absolute top-[21px] left-0 text-[12px] font-semibold text-[#767676] leading-[22px]" style={{ fontFamily: 'Montserrat Alternates, sans-serif' }}>Карта</span>
                </button>
                <button className="mt-[18px] ml-[80px] relative w-[59px] h-[43px] flex flex-col items-center">
                    <div className="w-[28px] h-[28px] bg-[#35741F] rounded-full flex items-center justify-center mb-0">
                        <svg className="w-[23.33px] h-[23.33px] text-white" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/>
                        </svg>
                    </div>
                    <span className="absolute top-[21px] left-0 text-[12px] font-semibold text-[#35741F] leading-[22px]" style={{ fontFamily: 'Montserrat Alternates, sans-serif' }}>Профиль</span>
                </button>
            </div>
